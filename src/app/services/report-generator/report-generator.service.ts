...
export class ReportGeneratorService {
  ...
  uploadChartAccountReport(file: File): Observable<EntityResponseType> {
    const formData = new FormData();
    formData.append('file', file);
  ...
  uploadDailyAccountReport(file: File): Observable<EntityResponseType> {
    const formData = new FormData();
    formData.append('file', file);
  ...
  uploadSuscriberDebtReport(file: File): Observable<EntityResponseType> {
    const formData = new FormData();
    formData.append('file', file);
  ...
  deleteClients(): Observable<HttpResponse<{}>> {
    return this.http.delete(
      ReportGeneratorConstants.REPORT_GENERATOR_ENDPOINT_URL + 'clients/delete',
      { observe: 'response' }
    );
  }
  ...
  deleteChartAccountReport(): Observable<HttpResponse<{}>> {
    return this.http.delete(
      ReportGeneratorConstants.REPORT_GENERATOR_ENDPOINT_URL +
  ...
  deleteDailyAccountReport(): Observable<HttpResponse<{}>> {
    return this.http.delete(
      ReportGeneratorConstants.REPORT_GENERATOR_ENDPOINT_URL +
        'dailyAccount/delete',
      { observe: 'response' }
  ...
  deleteSuscriberDebReport(): Observable<HttpResponse<{}>> {
    return this.http.delete(
      ReportGeneratorConstants.REPORT_GENERATOR_ENDPOINT_URL +
        'suscriberDebt/delete',
      { observe: 'response' }
    );
  }
  ...
  deleteIva(): Observable<HttpResponse<{}>> {
    return this.http.delete(
      ReportGeneratorConstants.REPORT_GENERATOR_ENDPOINT_URL + 'iva/delete',
      { observe: 'response' }
    );
  }
  ...
  generate1001Report(): Observable<any> {
    return this.http.get<any>(
      ReportGeneratorConstants.REPORT_GENERATOR_ENDPOINT_URL +
        'reportCreator/generateReport1001',
      { observe: 'response' }
    );
  }

  generate1005Report(): Observable<any> {
    return this.http.get<any>(
      ReportGeneratorConstants.REPORT_GENERATOR_ENDPOINT_URL +
        'reportCreator/generateReport1005',
      { observe: 'response' }
    );
  }

  generate1006Report(): Observable<any> {
    return this.http.get<any>(
      ReportGeneratorConstants.REPORT_GENERATOR_ENDPOINT_URL +
        'reportCreator/generateReport1006',
      { observe: 'response' }
    );
  }

  generate1007Report(): Observable<any> {
    return this.http.get<any>(
      ReportGeneratorConstants.REPORT_GENERATOR_ENDPOINT_URL +
        'reportCreator/generateReport1007',
      { observe: 'response' }
    );
  }

  generate1008Report(): Observable<any> {
    return this.http.get<any>(
      ReportGeneratorConstants.REPORT_GENERATOR_ENDPOINT_URL +
        'reportCreator/generateReport1008',
      { observe: 'response' }
    );
  }
  generate1009Report(): Observable<any> {
    return this.http.get<any>(
      ReportGeneratorConstants.REPORT_GENERATOR_ENDPOINT_URL +
        'reportCreator/generateReport1009',
      { observe: 'response' }
    );
  }
}
